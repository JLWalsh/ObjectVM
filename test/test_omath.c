...
void test_int16_endian_swap() {
  ...
  int32_t big_endian = omath_int16_endian_swap(small_endian);
...
void test_int64_endian_swap() {
  ...
  int64_t big_endian = omath_int64_endian_swap(small_endian);
...
void test_int32_endian_swap() {
  ...
  int32_t big_endian = omath_int32_endian_swap(small_endian);
